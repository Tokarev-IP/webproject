...
var isValidBodyParams = ajv.compile(types_schema_default.definitions["SignInBody"] || {});
...
var handler = async (event) => {
  try {
    ...
    if (!isValidBodyParams(body)) {
      ...
      const res = {
        ...
        body: JSON.stringify({
          ...
          schema: types_schema_default.definitions["SignInBody"]
        })
      };
      return res;
    }
    ...
    const command = new import_client_cognito_identity_provider.InitiateAuthCommand(params);
